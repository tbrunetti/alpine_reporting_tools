...
/projects/kfotso@xsede.org/slurm_report/June_2024_/alpine_reporting_tools/scripts/scrape_user_metrics.sh USERS=brunetti@xsede.org,kfotso@xsede.org,msherren@xsede.org START_DATE=$YEAR-$previousMonth-$Format_day_week_ago END_DATE=$TODAY
